...
var _BeerList = __webpack_require__(355);

var _BeerList2 = _interopRequireDefault(_BeerList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_BeerList2.default, null), document.getElementById('app'));
...
var _GiphyImage = __webpack_require__(356);

var _GiphyImage2 = _interopRequireDefault(_GiphyImage);
...
var BeerList = function (_React$Component) {
  ...
  function BeerList(props) {
    ...
    var _this = _possibleConstructorReturn(this, (BeerList.__proto__ || Object.getPrototypeOf(BeerList)).call(this, props));
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                fetch('http://localhost:8080/good-beers').then(function (response) {
                  ...
                  return _this2.setState({ beers: data, isLoading: false });
                });
      ...
      return React.createElement(
        ...
        beers.map(function (beer) {
          return React.createElement(
            ...
            React.createElement(_GiphyImage2.default, { name: beer.name })
          );
        })
      );
    }
...
var GiphyImage = function (_React$Component) {
  _inherits(GiphyImage, _React$Component);

  function GiphyImage(props) {
    _classCallCheck(this, GiphyImage);

    var _this = _possibleConstructorReturn(this, (GiphyImage.__proto__ || Object.getPrototypeOf(GiphyImage)).call(this, props));
  ...
  _createClass(GiphyImage, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      var giphyApi = '//api.giphy.com/v1/gifs/search?api_key=dc6zaTOxFJmzC&limit=1&q=';

      fetch(giphyApi + this.props.name).then(function (response) {
        return response.json();
      }).then(function (response) {
        if (response.data.length > 0) {
          _this2.setState({ giphyUrl: response.data[0].images.original.url });
        } else {
          // dancing cat for no images found
          _this2.setState({ giphyUrl: '//media.giphy.com/media/YaOxRsmrv9IeA/giphy.gif' });
        }
    ...
    value: function render() {
      ...
      return React.createElement('img', { src: giphyUrl, alt: this.props.name, width: '200' });
    }
  }]);
